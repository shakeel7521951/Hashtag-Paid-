  ...
  return (
    <div className='mx-2 mt-6 mb-10'>
       ...
       <div className=' flex gap-2 items-center'>
            <Link to="/" className='hover:underline text-sm'>so-likeable</Link><span>{">"}</span>
            <Link to="/agencies" className='hover:underline text-sm'>Brands and Agencies</Link><span>{">"}</span>
            <Link to="#" className='hover:underline text-sm'>Brands and Agencies: Getting Started With so-likeabe</Link>
        </div>
        <div>
            <input type='text' placeholder='Search' className='border p-3 rounded-full min-w-[300px]'></input>
        </div>
       </div>
        <div className='flex flex-col sm:flex-row items-center justify-center mt-5 sm:mt-10'>
            <h1 className='font-customLight text-2xl sm:text-4xl text-center'>Brands and Agencies: Getting Started With #paid</h1>
            <button className='px-4 py-2 border sm:ms-5 rounded-xl hover:bg-black hover:text-white transition-all'>Follow</button>
        </div>
        <div className='ms-3 sm:ms-36 mt-5 flex flex-col gap-7'>
            {
                helpCenter.map(()=>(
                    <Link to="" className='hover:underline'>How to Prepare for #paid Strategic Kick Off Call</Link>
                ))
            }
        </div>
