      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center bg-black bg-opacity-50 p-6 pt-20 sm:p-10  w-full h-full rounded-[1rem] sm:rounded-[4rem]">
            {/* Main Heading */}
            <h1 className="text-white font-custom leading-none text-2xl sm:text-5xl lg:text-8xl sm:mx-36 mb-4">
              Connect with creators & brands
            </h1>

            {/* Subheading */}
            <p className="text-white font-customLight text-sm sm:text-lg lg:text-xl sm:mx-48 my-4">
              Spend the day learning, networking, and collaborating with the
              country's top marketers and creators.
            </p>

            {/* Buttons */}
            <div className="flex flex-wrap justify-center gap-4 my-4">
              <button className="bg-[#DDE041] px-4 py-2 text-lg sm:text-md rounded-3xl shadow-md hover:shadow-lg transition duration-300 font-customLight">
                New York, NY
              </button>
              <button className="bg-[#DDE041] px-4 py-2 text-lg sm:text-md rounded-3xl shadow-md hover:shadow-lg transition duration-300 font-customLight">
                Hall des Lumières
