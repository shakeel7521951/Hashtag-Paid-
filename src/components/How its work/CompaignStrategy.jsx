...
export default function CreatorWork() {
    ...
    const authenticator = [
        { id: 1, plus: <FaPlus />, title: 'Creators pitch campaign ideas', text: 'Creators know their audience best. Let them develop creative concepts and create memorable content that resonates with their audience.' },
        { id: 2, plus: <FaPlus />, title: 'Strategy backed by research and trends ', text: 'Have confidence in your campaign strategy with benchmarks and normative data from over 30K respondents.' },
        { id: 3, plus: <FaPlus />, title: 'Dedicated strategists', text: 'You’ll have a team of experts proactively working with you to make sure every campaign is on schedule, brand safe, and successful.' },
        { id: 4, plus: <FaPlus />, title: 'Concept & content approval', text: 'Have full control over the creative and copy that goes live without having to manage any back and forth communication with creators.' },
    ];
                ...
                <div className=" w-[90%] mx-auto flex flex-col sm:flex-row md:flex-row-reverse gap-5 justify-around">
                    ...
                    <div className='w-full sm:w-[50%] max-h-full order-2 sm:order-1 '>
                        <div className=" w-[300px] sm:w-[300px]  p-3 rounded-[30px] flex justify-center items-center bg-[#dde041]">
                            <span>Campaign strategy & management</span>
                        </div>
