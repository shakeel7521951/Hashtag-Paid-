...
import strategy from '../../assets/agencies/strategy.webp';
  ...
  return (
    <div className='bg-[#F2F0EB] w-full flex flex-col sm:flex-row px-6 sm:px-10 rounded-xl py-10 mx-auto sm:py-14 gap-6'>
        <div className='w-full sm:w-[50%] mt-4 sm:mt-10 order-2 sm:order-1'>
            <button className='bg-[#DDE041] py-2 px-3 rounded-full'>Strategy</button>
            <h1 className='text-lg sm:text-5xl font-custom py-7'>In-house strategic experts on every campaign</h1>
            ...
            <div className='flex flex-col gap-3'>
                ...
                <div className='flex gap-2'>
                    <img src={tick} alt='Tick' />
                    <p>Creator audience demographics</p>
                </div>
            </div>
        </div>
